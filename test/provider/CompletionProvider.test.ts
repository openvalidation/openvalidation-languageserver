...
describe('Completion provider test', () => {
    ...
    test('completionForSchema with Einkaufsliste, expected global items', async () => {
        ...
        const actual: CompletionItem[] | null = await provider['completionForSchema'](document, params)!;
    ...
    test('completionMethodSwitch with Array params, expected same result', async () => {
        ...
        const expected: CompletionItem[] | null = await provider['completionForArray'](document, params)!;
        const actual: CompletionItem[] | null = await provider['completionMethodSwitch'](document, params)!;
    ...
    test('completionMethodSwitch with Schema params, expected global items', async () => {
        ...
        const expected: CompletionItem[] | null = await provider['completionForSchema'](document, params)!;
        const actual: CompletionItem[] | null = await provider['completionMethodSwitch'](document, params)!;
    ...
    test('completionMethodSwitch without special params, expected same result as completionByText', async () => {
        ...
        const expected: CompletionItem[] | null = await provider['completionByText'](document, params)!;
        const actual: CompletionItem[] | null = await provider['completionMethodSwitch'](document, params)!;
    ...
    test('extractItem with multiple lines, expect correct text and start line', () => {
        const textInput: string[] = ['Wenn test', 'Dann bla', '', 'Stuff', 'Als Test', '', 'TextToFind', 'find'];
