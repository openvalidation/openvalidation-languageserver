...
describe("Dummy Tests", () => {
    ...
    test("getCompletionContainer with empty RuleNode, expected RuleStart", () => {
        ...
        var expected: CompletionState[] = [CompletionState.RuleStart];
        var actual: CompletionState[] = rule.getCompletionContainer(positionParameter).getState();
    ...
    test("getCompletionContainer with complete Operation, expected ConnectedOperation and RuleEnd", () => {
        ...
        var expected: CompletionState[] = [CompletionState.ConnectedOperation, CompletionState.RuleEnd];
        var actual: CompletionState[] = rule.getCompletionContainer(positionParameter).getState();
