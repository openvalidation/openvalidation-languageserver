...
describe('VariableNameNode Tests', () => {
    ...
    test('VariableNameNode get errorMessage test', () => {
        ...
        const variableNode: VariableNameNode =
            new VariableNameNode([variableName], IndexRange.create(0, 0, 0, variableName.length), variableName);
    ...
    test('getBeautifiedContent test, expect not empty content', () => {
        ...
        const actual = variableNode.getBeautifiedContent(initializer.$server.aliasHelper);
    ...
    test('getCompletionContainer test, empty transition', () => {
        ...
        const actual: StateTransition = variableNode.getCompletionContainer(Position.create(0, 5)).$transitions[0];
