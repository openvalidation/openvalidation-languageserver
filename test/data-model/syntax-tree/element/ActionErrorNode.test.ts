...
describe('ActionErrorNode Tests', () => {
    ...
    test('getBeautifiedContent test, expect not empty content', () => {
        ...
        const actual = errorNode.getBeautifiedContent(initializer.$server.aliasHelper);
    ...
    test('getCompletionContainer test, expect empty transition', () => {
        ...
        const actual: StateTransition = errorNode.getCompletionContainer(Position.create(0, 5)).$transitions[0];
