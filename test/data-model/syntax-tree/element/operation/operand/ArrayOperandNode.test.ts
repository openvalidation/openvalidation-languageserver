...
describe('ArrayOperandNode Tests', () => {
    ...
    test('getChildren without children, expect no children', () => {
        ...
        const arrayOperandNode: ArrayOperandNode =
            new ArrayOperandNode([], [operand], IndexRange.create(0, 0, 0, operand.length), 'String', operand);
    ...
    test('getBeautifiedContent test, expect not empty content', () => {
        ...
        const actual = arrayOperandNode.getBeautifiedContent(initializer.$server.aliasHelper);
    ...
    test('getCompletionContainer without children, expect empty operand transition list', () => {
        ...
        const actual: StateTransition[] = arrayOperandNode.getCompletionContainer(Position.create(0, 5)).$transitions;
    ...
    test('getPatternInformation with single operand, expect variable', () => {
        ...
        const actual: ScopeEnum[] = arrayOperandNode.getPatternInformation(initializer.$server.aliasHelper)!.$capture;
    ...
    test('getPatternInformation with complex static decimal operand, expect empty and static number', () => {
        ...
        const operandNode: OperandNode =
            new OperandNode([operand], IndexRange.create(0, 0, 0, operand.length), 'Decimal', '100', true);
        const arrayOperandNode: ArrayOperandNode =
            new ArrayOperandNode(
                [operandNode], [operand], IndexRange.create(0, 0, 0, operand.length), 'String', operand);
    ...
    test('getPatternInformation with complex schema operand, expect empty, variable', () => {
        ...
        const operandNode: OperandNode =
            new OperandNode([operand], IndexRange.create(0, 0, 0, operand.length), 'Decimal', 'Student.Alter');
        const arrayOperandNode: ArrayOperandNode =
            new ArrayOperandNode(
                [operandNode], [operand], IndexRange.create(0, 0, 0, operand.length), 'String', operand);
