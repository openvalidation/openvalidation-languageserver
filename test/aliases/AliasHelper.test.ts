...
describe('AliasHelper Tests', () => {
    ...
    test('getKeywordByAliasKey with valid key, expect value', () => {
        ...
        const actual: string[] = aliasHelper.getKeywordsByAliasKeys(AliasKey.AND, AliasKey.COMMENT);
    ...
    test('getKeywordByAliasKey with one valid and one invalid key, expect one found value', () => {
        ...
        const actual: string[] = aliasHelper.getKeywordsByAliasKeys(AliasKey.AND, AliasKey.CONSTRAINT);
